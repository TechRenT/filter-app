...
urlpatterns = [
    ...
    url(r'^qualify_url/travel_warning/$', views.qualify_url_travel_warning, name='qualify_url_travel_warning'),
    ...
    url(r'^qualify_url/history/$', views.qualify_url_history, name='qualify_url_history'),
